// bundler v0.1.0 007a23167e5c3b08698f00ca7442193b18ea108c
// --
...
func WebRPCSchemaHash() string {
	return "007a23167e5c3b08698f00ca7442193b18ea108c"
}
...
type Bundler interface {
	...
	Broadcast(ctx context.Context, data interface{}) (bool, error)
}
...
func (s *bundlerServer) serveBroadcastJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.Bundler.Broadcast(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (c *bundlerClient) Broadcast(ctx context.Context, data interface{}) (bool, error) {
	in := struct {
		Arg0 interface{} `json:"data"`
	}{data}
	out := struct {
