...
// SimulationSettings is a free data retrieval call binding the contract method 0xfe3a32c2.
//
// Solidity: function simulationSettings() pure returns((address,address,(bytes32,bytes32)[])[] replacements)
func (_MockEndorser *MockEndorserCaller) SimulationSettings(opts *bind.CallOpts) ([]IEndorserReplacement, error) {
	var out []interface{}
	err := _MockEndorser.contract.Call(opts, &out, "simulationSettings")
...
//
// Solidity: function simulationSettings() pure returns((address,address,(bytes32,bytes32)[])[] replacements)
func (_MockEndorser *MockEndorserSession) SimulationSettings() ([]IEndorserReplacement, error) {
	return _MockEndorser.Contract.SimulationSettings(&_MockEndorser.CallOpts)
}

// SimulationSettings is a free data retrieval call binding the contract method 0xfe3a32c2.
//
// Solidity: function simulationSettings() pure returns((address,address,(bytes32,bytes32)[])[] replacements)
func (_MockEndorser *MockEndorserCallerSession) SimulationSettings() ([]IEndorserReplacement, error) {
	return _MockEndorser.Contract.SimulationSettings(&_MockEndorser.CallOpts)
}
