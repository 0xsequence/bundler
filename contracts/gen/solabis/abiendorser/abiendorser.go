...
//
// Solidity: function simulationSettings() view returns((address,address,(bytes32,bytes32)[])[] replacements)
func (_Endorser *EndorserCaller) SimulationSettings(opts *bind.CallOpts) ([]IEndorserReplacement, error) {
	var out []interface{}
	err := _Endorser.contract.Call(opts, &out, "simulationSettings")
...
//
// Solidity: function simulationSettings() view returns((address,address,(bytes32,bytes32)[])[] replacements)
func (_Endorser *EndorserSession) SimulationSettings() ([]IEndorserReplacement, error) {
	return _Endorser.Contract.SimulationSettings(&_Endorser.CallOpts)
}

// SimulationSettings is a free data retrieval call binding the contract method 0xfe3a32c2.
//
// Solidity: function simulationSettings() view returns((address,address,(bytes32,bytes32)[])[] replacements)
func (_Endorser *EndorserCallerSession) SimulationSettings() ([]IEndorserReplacement, error) {
	return _Endorser.Contract.SimulationSettings(&_Endorser.CallOpts)
}
